...
SLIDES = [
    ...
    f"""<div class="slide"><div class="bar"></div>
        ...
        <ul>
            ...
            <li><b>SOM (12 meses)</b> — 5,000 usuarios Premium × S/30 = <b>S/150k MRR</b> (0.5% del SAM).</li>
        </ul>
    ...
    f"""<div class="slide"><div class="bar"></div>
        ...
        <table>
            ...
            <tr><td>Free</td><td>S/0</td><td>Mapa + 3 análisis/mes</td></tr>
            <tr><td>Premium</td><td>S/30/mes</td><td>Análisis ilimitados + alertas</td></tr>
            <tr><td><b>Pro corredores</b></td><td><b>S/90/mes</b></td><td>Tasación ilimitada + leads ← el dinero</td></tr>
        </table>
        <p class="lead" style="margin-top:22px">Margen de contribución <b>~99%</b>
        (costo ~S/0.04 por análisis en tokens). Corredores: ROI claro = preciar bien → alquilar más rápido.</p>
        {footer(8)}</div>""",
    # 9 — Competencia & moat
    f"""<div class="slide"><div class="bar"></div>
    ...
    f"""<div class="slide cover">
        ...
        <ul style="margin-top:10px">
            <li><b>Hoy:</b> app desplegada · 1,475 avisos · R²=0.82 · entrevistas de validación.</li>
