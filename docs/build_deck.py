...
SLIDES = [
    ...
    f"""<div class="slide"><div class="bar"></div>
        ...
        <table>
            ...
            <tr><td><b>Pro</b></td><td><b>S/20/mes</b></td><td>Análisis ilimitados + alertas</td></tr>
            <tr><td>Corredores (próx.)</td><td>B2B</td><td>Dashboard + leads</td></tr>
        </table>
        <p class="lead" style="margin-top:22px">Precio pensado para el inquilino limeño.
        Margen de contribución <b>~99%</b> (costo ~S/0.04 por análisis en tokens).
        Próximo lado B2B: corredores que tasan a diario.</p>
        {footer(8)}</div>""",
    # 9 — Competencia & moat
    f"""<div class="slide"><div class="bar"></div>
